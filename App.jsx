...
const CASES = [
  ...
  { id: "jones", name: "Jones v. U.S.", year: 1983, court: "SCOTUS", category: "NGRI Release",
    ...
    significance: "• Standard of Proof: A preponderance of the evidence is constitutionally adequate; requiring proof beyond a reasonable doubt would place an excessive burden on the state • Equal Protection: Insanity acquitees are not similarly situated to convicted criminals. Their confinement is justified by mental health needs and protection of society, not by retribution or deterrence. • Insanity acquitees may be automatically committed upon acquittal. • Continued confinement is valid if the state proves by a preponderance of the evidence that the individual remains mentally ill and dangerous. • Confinement is based on mental illness and risk to society, not on the underlying criminal sentence.",
  ...
  { id: "ibntamas", name: "Ibn-Tamas v. U.S.", year: 1979, court: "D.C. Ct. App.", category: "Diminished Capacity",
    ...
    significance: "There are 2 ways an expert can subvert the jury's finction - they can speak directly about the ultime issue, or can speak with no more sophistication than the average layman (beyond the ken). With respecet to admission testimony in matters that are not \"beyond the ken\", it is admissible if: the subject matter is beyond the lay pererson, the expert has sufficient knowledge and experience that will aid the trier of fact, and the state in question does not have a law against it.",
  ...
  { id: "hartogs", name: "Roy v. Hartogs", year: 1976, court: "NY App. Ct.", category: "HIPAA & Patient Liability",
    ...
    issue: "Whether Hartogs' actions consitutued malpractice and whether the case was barred by \"Heart Balm Act\" which limited claims r/t 'seduction'.",
    ...
    significance: "Punitive damages prohibited because Appellate Court did not believe the defednat had evil or malicious intent; cited Freud's advice to not sleep with or kiss patients in opinion.",
  ...
  { id: "clites", name: "Clites v. Iowa", year: 1982, court: "IA Ct. App.", category: "HIPAA & Patient Liability",
    ...
    issue: "Whether the trial court had applied correct standard of carre, and whether the awarded damages were excessive and unsupported by evidence.",
    holding: "COA held that the trial court and applied the correct standard of carer and that the damages were appropriate. Award of 385k for furture medical expenses and $275k for past and future pain and suffering was not found to be excessive.",
    significance: "There was insufficient evidence that Mr. Clites had severe aggression or self injury to justify the use of the medications; the staff failed to adequately monitor Mr. Clites for TD; failed to stop the meds when TD emerged; staff failed to consult TD experts; polypharmacy masked the TD symptoms; use of meds was seen as convenience for staff rather than a therapeutic program. Court said that the First Amendmeent gives patient a right to refuse, and an instution is required to obtain informed consent. Mr. Clites' parents knew he was receiving medications but risks were not explained nor ws consent sought.",
